            ...
            <main className="pt-24">
                ...
                <section className="relative py-24 px-6 border-b border-gray-200 bg-gray-50">
                    <div className="max-w-7xl mx-auto text-center">
                        <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight text-gray-900">
                            Global Leader in <br />
                            <span className="text-amber-600">Functional Coating</span>
                        </h1>
                ...
                <section className="py-24 px-6 bg-white">
                    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                        {/* 왼쪽: CEO 이미지 영역 */}
                        <div>
                            <div className="w-full h-[500px] bg-gradient-to-b from-gray-100 to-gray-200 rounded-lg overflow-hidden relative group flex items-center justify-center">
                                {/* CEO 이미지 */}
                                <img
                                    src="/ceo.jpg"
                                    alt="CEO of HANMIR"
                        ...
                        <div>
                            <h2 className="text-3xl font-bold text-gray-900 mb-6">CEO 인사말</h2>
                            ...
                            {/* 주요 통계 수치 */}
                            <div className="flex gap-8 mt-8 border-t border-gray-200 pt-8">
                                <div>
                ...
                <section className="py-24 px-6 bg-gray-50 border-t border-gray-200">
                    <div className="max-w-7xl mx-auto">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-gray-500">한미르의 성장 발자취</p>
                        </div>

                        {/* 타임라인 */}
                        <div className="relative">
                            {/* 중앙 세로선 */}
                            <div className="absolute left-1/2 transform -translate-x-1/2 h-full w-px bg-gray-300 hidden md:block" />
                            ...
                            {[
                                ...
                                >
                                    ...
                                    <div className={`w-full md:w-1/2 ${idx % 2 === 0 ? 'md:pr-12 md:text-right' : 'md:pl-12 md:text-left'}`}>
                                        <div className="p-6 bg-white border border-gray-200 rounded-lg hover:border-amber-500/50 transition-colors group shadow-sm">
                                    ...
                                    <div className="absolute left-1/2 transform -translate-x-1/2 hidden md:flex items-center justify-center">
                                        <div className="w-4 h-4 bg-amber-500 rounded-full border-4 border-white shadow" />
                                    </div>
                ...
                <section className="py-24 px-6 bg-white border-t border-gray-200">
                    <div className="max-w-7xl mx-auto text-center">
                        <h2 className="text-2xl font-bold text-gray-900 mb-12">인증 및 수상 내역</h2>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            {['ISO 9001', 'ISO 14001', 'INNO-BIZ', '벤처기업인증'].map((cert, idx) => (
                                <div key={idx} className="p-8 border border-gray-200 rounded flex items-center justify-center hover:border-amber-500 transition-colors bg-gray-50">
                                    <span className="text-gray-600 font-bold">{cert}</span>
                                </div>
                            ))}
                        </div>
                    </div>
